    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.methodCard}>
                <Image
                    source={require("/Users/alisajjad/Desktop/FYP/fyp-frontend/assets/images/GetStarted.png")} // Replace with your card image path
            ...
            <View style={styles.inputContainer}>
                <Image
                    source={require("/Users/alisajjad/Desktop/FYP/fyp-frontend/assets/images/GetStarted.png")} // Replace with your user icon path
                    style={styles.icon}
                />
            ...
            <View style={styles.inputContainer}>
                <Image
                    source={require("/Users/alisajjad/Desktop/FYP/fyp-frontend/assets/images/GetStarted.png")} // Replace with your card icon path
                    style={styles.icon}
                />
            ...
            <View style={styles.row}>
                <View style={styles.inputContainerSmall}>
                    <Image
                        source={require("/Users/alisajjad/Desktop/FYP/fyp-frontend/assets/images/GetStarted.png")} // Replace with your calendar icon path
                        style={styles.icon}
                    />
                ...
                <View style={styles.inputContainerSmall}>
                    <Image
                        source={require("/Users/alisajjad/Desktop/FYP/fyp-frontend/assets/images/GetStarted.png")} // Replace with your lock icon path
                        style={styles.icon}
                    />
